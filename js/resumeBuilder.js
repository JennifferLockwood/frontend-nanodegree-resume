	...
	'display' : function() {
		...
		if (education.schools.length > 0) {
			...
			for (var i=0; i < education.schools.length; i++) {
				...
				$('.education-entry:last').append(schoolUrl + schoolDegree, schoolDates, schoolLocation, schoolMajor);
			}
		}
		...
		if (education.onlineCourses.length > 0) {
			...
			for (var i=0; i < education.onlineCourses.length; i++) {
				...
				$('.education-entry:last').append(courseTitle + schl, courseDates, courseUrlLink);
			}
		}
	}
};
	...
	'display' : function() {
		...
		if (work.jobs.length > 0) {
			...
			for (var i=0; i < work.jobs.length; i++) {
				...
				$('.work-entry:last').append(urlEmployer + jobTitle, jobDates, jobLocation, jobDescription);
			}
		}	
	}
};
...
var projects = {
	...
	},
	{
		...
		'description' : 'Applying what I have learned in the CSS course, I recreated a web page from a design prototype.',
	...
	'display' : function() {
		...
		if (projects.projects.length) {
			...
			for (var i=0; i < projects.projects.length; i++) {
				...
				$('.project-entry:last').append(myProject, formattedDates, formattedDescription);
